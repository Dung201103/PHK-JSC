        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
                            .AddCookie(option =>
                            {
                                ...
                                option.AccessDeniedPath = "/Account/AccessDenined"; //URL trang cấm truy cập
            ...
            string connectionString = builder.Configuration.GetConnectionString("SV21T1020589") ?? "DefaultConnectionString";
            SV21T1020589.BusinessLayers.Configuration.Initialize( connectionString );
